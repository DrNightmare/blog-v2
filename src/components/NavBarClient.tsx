...
function NavLink({ href, children, activePath }: { href: string; children: ReactNode; activePath: string }) {
...
function MobileNavLink({ href, children, activePath }: { href: string; children: ReactNode; activePath: string }) {
  const isActive = activePath.startsWith(href);
