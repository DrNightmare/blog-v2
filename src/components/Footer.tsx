...
import { SITE_AUTHOR_NAME, SOCIAL_PROFILES } from "@/lib/siteIdentity";

function SocialIcon({ label }: { label: "GitHub" | "YouTube" }) {
  if (label === "GitHub") {
    return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-slate-400 text-sm dark:text-slate-500">
            © {new Date().getFullYear()} {SITE_AUTHOR_NAME}. All rights reserved.
          </p>
