...
type GameProjectContainerProps = {
    gameComponent: ReactNode;
    rulesComponent: ReactNode;
};

export default function GameProjectContainer({ gameComponent, rulesComponent }: GameProjectContainerProps) {
    ...
    return (
        <div className="w-full max-w-4xl mx-auto">
            ...
            <div className="min-h-[600px]">
                {activeTab === 'game' ? gameComponent : rulesComponent}
            </div>
        </div>
    );
}
