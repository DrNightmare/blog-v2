        ...
        <div>
            <main className="flex gap-8 items-center justify-center sm:items-start">
                <div className="flex flex-col prose">
                    <span className="text-3xl text-center">Essays <span className="text-sea-blue text-2xl">{essays.length}</span></span>
                        ...
                        <div className="not-prose my-2" key={essay.slug}>
                            <Link className="not-prose" href={`/essays/${essay.slug}`}>
                                <div className="group cursor-pointer mb-2">
                                    <p className="text-lg font-medium group-hover:text-crimson group-hover:font-bold">{essay.metadata.title}</p>
